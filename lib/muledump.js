...
//  check for updates and display a lightbox with the results
    function checkupdates(force) {
        ...
        function BaseMessage() {
            ...
            setuptools.lightbox.build('muledump-about', 'Вы используете актуальную версию.<br>');
        ...
        function DisplayMessage() {
            ...
            setuptools.lightbox.build('muledump-about', ' \
                <br><a href="' + setuptools.config.url + '/CHANGELOG" class="drawhelp docs nostyle" target="_blank">Список изменений</a> | \
                <a href="' + setuptools.config.url + '/" target="_blank">Домашнаяя страница</a> | \
                <a href="https://github.com/jakcodex/muledump" target="_blank">GitHub</a> \
                <br><br>Поддержка в Discord - <a href="https://discord.gg/JFS5fqW" target="_blank">https://discord.gg/JFS5fqW</a>\
                <br><br>Вы можете воспользоваться Muledump без скачивания! \
                <br><br>Перейдите по <a href="' + setuptools.config.url + '/muledump.html" target="_blank">ссылке</a> для использования. \
            ');
            if ( setuptools.state.loaded === true && setuptools.data.config.enabled === true ) setuptools.lightbox.build('muledump-about', ' \
                <br><br>Создайте и загрузите локальную <a href="#" class="setuptools app backups noclose">резервную копию</a> для моментальной настройки. \
            ');
            ...
            $('.drawhelp.docs').click(function(e) {
                setuptools.lightbox.ajax(e, {title: 'Подробнее о Muledump', url: $(this).attr('href')}, this);
            });
        ...
        function ProcessResponse(data) {
            ...
            if ( latestRenders > currentRenders ) setuptools.app.muledump.notices.add(
                'Найдено обновление для версии ' + latestRendersName,
            ...
            if ( url && ( force === true || (!force && options.updatecheck === true && (typeof notifiedver === 'undefined' || (typeof notifiedver === 'string' && cmpver(notifiedver, topver) > 0)))) ) {
                ...
                setuptools.lightbox.build('muledump-about', ' \
                    <div style="width: 100%; border: #ffffff solid 2px; padding: 10px; background-color: #111;">\
                        Jakcodex/Muledump v' + topver + ' уже доступен! \
        ...
        $('#about').bind('click', function() {
            if ( setuptools.state.hosted === false ) {
                ...
                setuptools.lightbox.build('muledump-checkupdates', ' \
                    ...
                    <a href="' + setuptools.config.url + '/" target="_blank">Домашняя страница</a> | \
                    <a href="https://github.com/jakcodex/muledump" target="_blank">GitHub</a> \
                    <br><br>Онлайн версия обновляется сразу после выхода. \
                    <br><br>Поддержка в Discord - <a href="https://discord.gg/JFS5fqW" target="_blank">https://discord.gg/JFS5fqW</a> \
                ');
