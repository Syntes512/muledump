...
setuptools.app.mulequeue.ui.manager = function(guid) {
    ...
    function DrawButtons() {
        ...
        if ( setuptools.app.mulequeue.state.running === false ) {
            ...
            html += ' \
                <div class="setuptools menuStyle buttonStyle positive mulequeue main menu reload noselect" title="Перезагрузить все аккаунты" style="float: right; font-weight: normal;">&#9654;</div> \
            ';
    ...
    function createRow(listPos) {
        ...
        return ' \
            <div class="flex-container queuetask noselect" style="justify-content: flex-start;" data-listPos="' + listPos + '"> \
                <div style="flex-basis: 30px; height: 24px; justify-content: center; align-items: center;" class="flex-container textCenter" title="Приоритет: ' + (listPos+1) + '">' + setuptools.app.mulequeue.spinner.running(undefined, true) + '</div> \
