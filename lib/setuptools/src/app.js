...
setuptools.app.introduction = function() {
    ...
    setuptools.lightbox.build('introduction', ' \
        ...
        <br><br>Также вы можете посетить wiki страницу: <a href="' + setuptools.config.source + '/muledump/wiki/Installation-and-Setup" class="setuptools noclose" target="_blank">Инструкция по установке и настройке</a>. \
    ...
    if ( setuptools.app.checknew() === true ) {
        ...
        setuptools.lightbox.build('main', ' \
            ...
            <br><br><a href="' + setuptools.config.url + '" class="setuptools noclose" target="_blank">Обзор</a> | \
                ...
                <a href="https://github.com/jakcodex/muledump/wiki/Installation-and-Setup" class="setuptools noclose" target="_blank">Инструкция по установке и настройке</a>\
