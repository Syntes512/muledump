...
setuptools.lightbox.menu.paginate.create = function(PageList, ActionItem, ActionContainer, ActionSelector, ActionCallback, ActionContext, Modifiers) {
    ...
    state.html.menu = ' \
        <div class="setuptools div pageControls full"> \
            <div class="editor control firstPage noselect" title="Первая страница">&#171;</div> \
            <div class="editor control previousPage noselect" title="Предыдущая страница">&#8249;</div> \
            <div class="editor control customPage"><input name="customPage" value="' + ( (state.currentPage > -1) ? state.currentPage+1 : 1 ) + '"><span class="noselect"> из ' + (state.lastPage+1) + ' страниц' + ( ((state.lastPage+1) < 1) ? 'ы' : '' ) + '</span></div> \
            <div class="editor control gotoPage noselect" title="Перейти">&#x1F50E</div> \
            \
            <div class="editor control lastPage noselect" title="Последная страница">&#187;</div> \
            <div class="editor control nextPage noselect" title="Следующая страница">&#8250;</div> \
    ...
    state.html.search = ' \
        <div class="setuptools div pageControls">\
            <div class="editor control searchName" title=""><input name="searchName" placeholder="Поиск по имени" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></div> \
            <div class="editor control search noselect" title="Найти">&#x1F50E</div> \
        </div>\
    ';
...
setuptools.lightbox.display = function(page, config) {
    ...
    //  create the lightbox from the build data
        ...
        if ( ['drawhelp', 'main', 'accounts-deepcopy-download', 'settings-eraseAll-complete', 'settings-erase-completed', 'browser-assistant'].indexOf(page) === -1 ) {
            ...
            setuptools.lightbox.builds[page].push('<a href="#" class="drawhelp gohome" title="Дом"' + (( typeof drawhelpData === 'object' ) ? ' style="right: ' + widthOffset + 'px;"' : '') + '>&#9751;</a>');
        }
...
setuptools.lightbox.error = function(message, code) {
    ...
    setuptools.lightbox.create(' \
        <p><span class="setuptools error">Ошибка ' + code + '</span> - ' + message + '</p> \
        <span>Просмотрите <a href="https://github.com/Syntes512/muledump/wiki" target="_blank">Setup Tools</a> для более полной помощи.</span> \
    ');
